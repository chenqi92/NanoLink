...
export function SummaryCards({ 
  ...
  const cards = [
    ...
    {
      title: t("dashboard.totalDisk"),
      value: formatPercent(diskPercent),
      subtitle: `${formatBytes(usedDisk)} / ${formatBytes(totalDisk)}`,
      icon: HardDrive,
      color: diskPercent > 90 ? "text-red-500" : diskPercent > 70 ? "text-yellow-500" : "text-green-500",
      bgColor: diskPercent > 90 ? "bg-red-500/10" : diskPercent > 70 ? "bg-yellow-500/10" : "bg-green-500/10",
    },
  ]
