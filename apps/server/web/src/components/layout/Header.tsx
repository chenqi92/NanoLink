...
import { Sun, Moon, Monitor, Globe, LogOut, User, Users, Shield, Settings } from "lucide-react"
...
export function Header({ user, agentCount, hasError, onLogout, onNavigate }: HeaderProps) {
      ...
      <div className="flex h-14 items-center px-6">
        ...
        <div className="ml-auto flex items-center gap-3">
          <span className="text-sm text-[var(--color-muted-foreground)]">
            {agentCount} {t("dashboard.connectedAgents")}
          </span>
          <div
            className={`h-2 w-2 rounded-full ${hasError ? "bg-red-500" : "bg-green-500"}`}
          />
