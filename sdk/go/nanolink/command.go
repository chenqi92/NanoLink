...
const (
	...
	// Package Management
	CommandPackageInstall CommandType = 84
	...
	// Build execution
	CommandBuildExecute   CommandType = 130
	CommandBuildCancel    CommandType = 131
	CommandBuildGitStatus CommandType = 132
)
...
func (c *Command) RequiredPermission() int {
	...
	case CommandSystemReboot, CommandShellExecute, CommandFileUpload, CommandPackageInstall,
		CommandDeployExecute, CommandDeployRollback, CommandBuildExecute, CommandBuildCancel,
		CommandBuildGitStatus:
